...
public class AspectInvokeProcessor {
    ...
    public static Object invokeSuper(Object o, Method method, Object[] objects, MethodProxy methodProxy,
        ...
        if (aopMethod != null) {
            aopMethod.getMethod().invoke(aopMethod.getBean(), new CgcgJoinPoint(o, method, objects, methodProxy));
        }

        Object result;
        aopMethod = aroundMethods.get(key);
        if (aopMethod != null) {
            result = aopMethod.getMethod().invoke(aopMethod.getBean(), new CgcgJoinPoint(o, method, objects, methodProxy));
        } else {
